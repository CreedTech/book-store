            ...
            >
                ...
                <View style={{ flexDirection: 'row', paddingHorizontal: SIZES.radius, height: 80, alignItems: 'flex-end' }}>
                    ...
                    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white,}}>Book Detail</Text>
                    </View>
                ...
                <View style={{ flex: 1.8, alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Text style={{ ...FONTS.body3, color: COLORS.white, }}>Published By - {book.publisher}</Text>
                </View>
                ...
                >
                    ...
                    {/* <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }} ellipsizeMode='tail'>{book.publisher}</Text>
                    ...
                    {/* <View style={{ flex: 1, paddingHorizontal: SIZES.radius, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }} >{book.pages}</Text>
                    ...
                    {/* Language */}
                    <View style={{ flex: 1, alignItems: 'center' }}>
                        <Text style={{ ...FONTS.h3, color: COLORS.white }} ellipsizeMode='tail' numberOfLines={1}>{book.subtitle}</Text>
                        {/* <Text style={{ ...FONTS.body4, color: COLORS.white }}>Subtitle</Text> */}
                    </View>
                </View>
            </View>
        )
